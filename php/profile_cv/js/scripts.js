$(function() {
  ...
  $("#blog-items .more-info").click(function(e) {
    ...
    $("#blog-items").hide();
    $(targetId + ", #full-blog-items #blog-back")
      .hide()
      .removeClass("hidden")
      .fadeIn("400", "easeInOutCubic");
  });

  $("#blog-back").click(function(e) {
    e.preventDefault();
    $(".blogitem-content:visible, #blog-back")
      .hide()
      .addClass("hidden");
  ...
  $("#portfolio-back").click(function(e) {
    e.preventDefault();
    $(".portfolioitem-content:visible, #portfolio-back")
      .hide()
      .addClass("hidden");
  ...
  $(".timeline-item-trigger span").click(function() {
    if ($(this).hasClass("circle_plus")) {
      $(this)
        .removeClass("circle_plus")
        .addClass("circle_minus");
    } else {
      $(this)
        .removeClass("circle_minus")
  ...
  $(".timeline-item-title").click(function() {
    $trigger = $(this)
      .parent()
      .parent()
      .find(".timeline-item-trigger span");
  ...
  $(document).on("mouseenter", ".blogitem, .portfolioitem", function() {
    $(".blogitem-hoverinfo, .portfolioitem-hoverinfo", this)
      .stop(true, true)
      .fadeIn("200", "easeInOutCubic");
  });

  $(document).on("mouseleave", ".blogitem, .portfolioitem", function() {
    $(".blogitem-hoverinfo, .portfolioitem-hoverinfo", this)
      .stop(true, true)
      .fadeOut("200", "easeInOutCubic");
  });
  ...
  function conditionalScripts(viewPortContext) {
    ...
    if (viewPortContext != newViewPortContext) {
      if (newViewPortContext == "desktop") {
        //scripts for desktop only
